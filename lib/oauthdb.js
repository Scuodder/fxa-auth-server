...
function mapOAuthError(log, err) {
  ...
  switch (err.errno) {
    ...
    default:
      ...
      return new error.invalidRequestParameter(err.message)
  }
}
    ...
    checkRefreshToken: {
      ...
      validate: {
        ...
        response: {
          ...
          sub: validators.hexString.required(), // subject
          aud: Joi.string(), // audience
          iss: Joi.string(), // issuer
          jti: validators.hexString.required(), // string identifier, as defined in JWT
